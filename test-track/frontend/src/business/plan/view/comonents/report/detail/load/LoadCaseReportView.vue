...
export default   {
  ...
  created(){
    if (this.planReportTemplate) {
      if (this.planReportTemplate.errorsSamples) {
        this.errorSamples = this.planReportTemplate.errorsSamples;
  ...
  methods: {
    ...
    handleInit(data) {
      if (data) {
        if (data.errorsSamples) {
          this.errorSamples = data.errorsSamples;
          this.haveErrorSamples = true;
        } else {
          this.haveErrorSamples = false;
        }
